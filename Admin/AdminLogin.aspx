...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-wrapper">
        ...
        <div class="card login-card">
            ...
            <asp:TextBox ID="txtAdminUser" runat="server" CssClass="input-box" placeholder="Enter your username"></asp:TextBox>

            <label>Password</label>
            <asp:TextBox ID="txtAdminPass" runat="server" TextMode="Password" CssClass="input-box" placeholder="Enter your password"></asp:TextBox>
            ...
            <asp:Button ID="btnAdminLogin" runat="server" Text="Login" CssClass="main-btn" OnClick="btnAdminLogin_Click" />
